define(['Can', 'element/RoundedRect', 'fill/Border', 'element/Text'], function(can, RoundedRect, Border, Text) {
	var Button = can.inherit(RoundedRect, {
	...
	$.extend(Button.prototype, {
		init: function() {
		    ...
		    this.on('mousedown', function(event) {
		    	this.setState(Button.State.DOWN);
		    });
