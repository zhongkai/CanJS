goog.provide('Stefan.ui.ToggleButton');

goog.require('Stefan.RoundedRect');
goog.require('Stefan.fill.Border');
goog.require('Stefan.Text');

Stefan.ui.ToggleButton = T.lang.createClass(function(config) {
	config = config || {};
    ...
    this.__state = Stefan.ui.ToggleButton.State.UP;
    
}, {
	superClass: Stefan.RoundedRect
});

Stefan.ui.ToggleButton.State = {
	UP: 0,
	DOWN: 1
};

Stefan.ui.ToggleButton.Event = {
    UP: 'up',
    DOWN: 'down',
    CLICK: 'click'
};

Stefan.ui.ToggleButton.extend({
	init: function() {
	    ...
	    this.on('mousedown', function(event) {
	    	this.setState(this.getState() == Stefan.ui.ToggleButton.State.UP? Stefan.ui.ToggleButton.State.DOWN : Stefan.ui.ToggleButton.State.UP);
	    });
	    ...
	    this.setState(Stefan.ui.ToggleButton.State.UP);
	},
	...
	setState: function(value) {
	    ...
	    if (Stefan.ui.ToggleButton.State.DOWN == value) {
